...
void matmul_simd(const float* A, const float* B, float* C,
    ...
    for (int i = 0; i < M; ++i) {
        for (int j = 0; j < N; ++j) {
            ...
            int p = 0;
            for (; p+63 < K; p+=64) {
                __m256 vec_a_1 = _mm256_load_ps(a+p); 
                __m256 vec_b_1 = _mm256_load_ps(b+p); 
                acc1 = _mm256_fmadd_ps(vec_a_1, vec_b_1, acc1);
                
                __m256 vec_a_2 = _mm256_load_ps(a+p+8); 
                __m256 vec_b_2 = _mm256_load_ps(b+p+8); 
                acc2 = _mm256_fmadd_ps(vec_a_2, vec_b_2, acc2);
                
                __m256 vec_a_3 = _mm256_load_ps(a+p+16); 
                __m256 vec_b_3 = _mm256_load_ps(b+p+16); 
                acc3 = _mm256_fmadd_ps(vec_a_3, vec_b_3, acc3);
                
                __m256 vec_a_4 = _mm256_load_ps(a+p+24); 
                __m256 vec_b_4 = _mm256_load_ps(b+p+24); 
                acc4 = _mm256_fmadd_ps(vec_a_4, vec_b_4, acc4);
                
                __m256 vec_a_5 = _mm256_load_ps(a+p+32); 
                __m256 vec_b_5 = _mm256_load_ps(b+p+32); 
                acc5 = _mm256_fmadd_ps(vec_a_5, vec_b_5, acc5);
                
                __m256 vec_a_6 = _mm256_load_ps(a+p+40); 
                __m256 vec_b_6 = _mm256_load_ps(b+p+40); 
                acc6 = _mm256_fmadd_ps(vec_a_6, vec_b_6, acc6);
                
                __m256 vec_a_7 = _mm256_load_ps(a+p+48); 
                __m256 vec_b_7 = _mm256_load_ps(b+p+48); 
                acc7 = _mm256_fmadd_ps(vec_a_7, vec_b_7, acc7);
                
                __m256 vec_a_8 = _mm256_load_ps(a+p+56); 
                __m256 vec_b_8 = _mm256_load_ps(b+p+56); 
